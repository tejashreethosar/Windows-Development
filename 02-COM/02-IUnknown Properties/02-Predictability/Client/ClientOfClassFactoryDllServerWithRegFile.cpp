/* COM is predictable over space and time - Predictability property of IUnknown */
#include <Windows.h>
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
		...
		//checking the predictability property of IUnknown
		Sleep(10000);
		hr = pISubtract->QueryInterface(IID_ISum, (void**)&pISumAgain);
		if(pISum == pISumAgain)
			MessageBox(hwnd, TEXT("ISum is obtained again after 10 seconds"), TEXT("Predictability"), MB_OK);
