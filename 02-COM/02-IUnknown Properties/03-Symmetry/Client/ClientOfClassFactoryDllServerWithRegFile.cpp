/*Symmetry property tells us that if ISum can give us ISubtract then ISubtract can also give us ISum*/
#include <Windows.h>
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
		...
		if(pISum == pISumAgain)
			MessageBox(hwnd, TEXT("pISum and pISumAgain both are same or symmetric"), TEXT("Result"), MB_OK);
		else
			MessageBox(hwnd, TEXT("pISum and pISumAgain both are not same or asymmetric"), TEXT("Result"), MB_OK);
