...
public:
	CMultiplicationDivision(IUnknown*);			//constructor method declaration
	~CMultiplicationDivision(void);				//destructor method declaration

	//Aggregation supported IUnknown specific declarations (inherited)
...
/*
STEPS TO RUN:
1. cl.exe /c /EHsc AggregationInnerComponentWithRegFile.cpp
2. link.exe AggregationInnerComponentWithRegFile.obj user32.lib gdi32.lib kernel32.lib ole32.lib oleaut32.lib /DLL /DEF:AggregationInnerComponentWithRegFile.def /SUBSYSTEM:WINDOWS
