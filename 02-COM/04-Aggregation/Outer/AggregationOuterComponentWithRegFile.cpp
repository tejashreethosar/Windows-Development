...
/*
STEPS TO RUN:
1. cl.exe /c /EHsc AggregationOuterComponentWithRegFile.cpp
2. link.exe AggregationOuterComponentWithRegFile.obj user32.lib gdi32.lib kernel32.lib ole32.lib oleaut32.lib /DLL /DEF:AggregationOuterComponentWithRegFile.def /SUBSYSTEM:WINDOWS
