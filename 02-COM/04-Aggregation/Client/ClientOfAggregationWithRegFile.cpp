...
2. cl.exe /c /EHsc ClientOfAggregationWithRegFile.cpp
3. link.exe ClientOfAggregationWithRegFile.obj user32.lib gdi32.lib kernel32.lib ole32.lib oleaut32.lib /SUBSYSTEM:WINDOWS
4. ClientOfAggregationWithRegFile.exe
*/
