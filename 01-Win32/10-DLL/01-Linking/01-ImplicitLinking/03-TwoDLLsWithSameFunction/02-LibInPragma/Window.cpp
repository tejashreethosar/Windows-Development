...
#include "MyMathOne.h"
#include "MyMathTwo.h"				
#pragma comment(lib, "MyMathOne.lib")				//can interchange the sequence of these two lines to invoke that DLL
#pragma comment(lib, "MyMathTwo.lib")				//Conclusion - The lib that gets linked first is executed (no ambiguity in 2 DLLs having same functions)
